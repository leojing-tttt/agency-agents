...
> **This fork** ships a campaign Agent product in [`apps/campaign-agent/`](apps/campaign-agent/). The markdown specialists below stay upstream agents — do not put application code in those directories.
